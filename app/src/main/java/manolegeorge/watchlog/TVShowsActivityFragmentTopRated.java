...
public class TVShowsActivityFragmentTopRated extends Fragment {
	...
	public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		loadMore.setOnClickListener(v -> {
			...
			StringRequest stringRequest2 = new StringRequest(Request.Method.POST, Constants.API_URL + "/shows/top_rated", response -> {
				try {
		...
		StringRequest stringRequest1 = new StringRequest(Request.Method.POST, Constants.API_URL + "/shows/top_rated", response -> {
			try {
