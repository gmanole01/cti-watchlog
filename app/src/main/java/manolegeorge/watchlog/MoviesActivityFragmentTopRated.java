...
public class MoviesActivityFragmentTopRated extends Fragment {
	...
	public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		@SuppressLint("InflateParams") final Button loadMore = (Button) inflater.inflate(R.layout.list_view_movies_footer, null);
		
		loadMore.setOnClickListener(v -> {
			page = page + 1;
			
			StringRequest stringRequest2 = new StringRequest(Request.Method.POST, Constants.API_URL + "/movies/top_rated", response -> {
				try {
		...
		StringRequest stringRequest1 = new StringRequest(Request.Method.POST, Constants.API_URL + "/movies/top_rated", response -> {
			try {
