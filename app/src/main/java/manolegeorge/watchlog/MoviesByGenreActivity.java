...
public class MoviesByGenreActivity extends AppCompatActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		loadMore.setOnClickListener(v -> {
			...
			StringRequest stringRequest2 = new StringRequest(Request.Method.POST, Constants.API_URL + "/get_movies_by_genre", response -> {
				try {
		...
		StringRequest stringRequest1 = new StringRequest(Request.Method.POST, Constants.API_URL + "/get_movies_by_genre", response -> {
			try {
