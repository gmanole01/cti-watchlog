	...
	public void onCreate(Bundle savedInstanceState) {
		...
		gridView.setOnScrollListener(new AbsListView.OnScrollListener() {
				...
				public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
					if((firstVisibleItem + visibleItemCount) == totalItemCount) {
						if(loadedMovies < totalMovies && !isLoadingMoreItems) {
							...
							StringRequest stringRequest2 = new StringRequest(Request.Method.POST, Constants.API_URL + "/get_hidden_watched_movies", new Response.Listener<String>() {
								@Override
			...
			gridView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
					...
					builder1.setItems(menuItems, new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							if(which == 0) {
								...
								StringRequest stringRequest4 = new StringRequest(Request.Method.POST, Constants.API_URL + "/remove_hidden_watched_movie", new Response.Listener<String>() {
									@Override
									public void onResponse(String response) {
										try {
											JSONObject jsonObject = new JSONObject(response);
				...
				StringRequest stringRequest1 = new StringRequest(Request.Method.POST, Constants.API_URL + "/get_hidden_watched_movies", new Response.Listener<String>() {
					@Override
					public void onResponse(String response) {
						try {
							JSONObject jsonObject = new JSONObject(response);
