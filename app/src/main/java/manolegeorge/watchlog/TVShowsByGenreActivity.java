	...
	public void onCreate(Bundle savedInstanceState) {
		...
		loadMore.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				StringRequest stringRequest2 = new StringRequest(Request.Method.POST, Constants.API_URL + "/get_tv_shows_by_genre", new Response.Listener<String>() {
					@Override
		...
		StringRequest stringRequest1 = new StringRequest(Request.Method.POST, Constants.API_URL + "/get_tv_shows_by_genre", new Response.Listener<String>() {
